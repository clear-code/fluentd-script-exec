...
class ReadTest < Test::Unit::TestCase
  ...
  test "Can read file with move" do
    ...
    result, status = Open3.capture2e("ruby", "exec.rb", filepath.to_s, "--move")
  ...
  test "dry-run does not move the file nor update the status file" do
    ...
    result, status = Open3.capture2e("ruby", "exec.rb", filepath.to_s, "--move", "--status-file", status_path.to_s, "--dry-run")
